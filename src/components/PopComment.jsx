export default function PopComment({ comment }, message) {
    console.log(comment.name, "TESTTTTTTTTTTTTTT")
    return (
            ...
            <div class="_comment_main">
                ...
                <div class="_comment_area">
                    <div class="_comment_details">
                        ...
                        <div class="_comment_status" style={{ width: "303px" }}>
                            <p class="_comment_status_text " style={{ width: "303px" }}>
