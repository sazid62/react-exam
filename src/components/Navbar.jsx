...
function Navbar() {
  ...
  console.log(currentUser.profile, " wewewe");
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <div class="_notification_box">
                        ...
                        <div class="_notification_txt">
                          <p class="_notification_para">
                            ...
                            <span class="_notify_txt_link">Freelacer usa</span>
                            to
                            <span class="_notify_txt_link">Freelacer usa</span>
                          </p>
                          <div class="_nitification_time">
          ...
          <div class="_header_nav_profile">
            ...
            <div class="_header_nav_dropdown">
              <p class="_header_nav_para"> {currentUser.username}</p>
              <button
            ...
            <div
              id="_prfoile_drop"
              class={`_nav_profile_dropdown _profile_dropdown ${
                dropDown ? "show" : ""
              }`}
            >
              <div class="_nav_profile_dropdown_info">
                ...
                <div class="_nav_profile_dropdown_info_txt">
                  <h4 class="_nav_dropdown_title">{currentUser.username}</h4>
